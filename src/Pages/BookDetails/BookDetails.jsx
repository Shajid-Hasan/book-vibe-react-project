...
const BookDetails = () => {
  ...
  if (!singleBook) {
    return (
      <p className="text-center my-10 text-4xl text-red-500">Book not found!</p>
    );
  }
  ...
  return (
    ...
    <div className="flex flex-col md:flex-row w-11/12 md:w-3/4 mx-auto gap-10 my-10">
      ...
      <div className="flex-1">
        <h2 className="text-2xl font-bold mb-2">{bookName}</h2>        <p className="text-gray-600 mb-2">By: {author}</p>
        ...
        <p>
          📅 <strong>Year:</strong> {yearOfPublishing}
        </p>
        <p>
        ...
        <div className="mt-5 flex gap-3">
          <button onClick={() => handelMarkAsRead(id)} className="btn btn-info">
            Read
          </button>
